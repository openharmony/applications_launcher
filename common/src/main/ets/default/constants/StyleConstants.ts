...
export class StyleConstants {
  ...
  static readonly TEXT_COLOR_PRIMARY = '#E6000000';
  static readonly BUTTON_FONT_COLOR = '#007DFF';
  static readonly DEFAULT_BUTTON_FONT_SIZE = '16fp';
  static readonly DEFAULT_DIALOG_BOTTOM_MARGIN = '16vp';
  ...
  static readonly DEFAULT_APP_GRID_COLUMN = 7;
  static readonly DEFAULT_APP_GRID_ROW = 4;
  static readonly DEFAULT_APP_GRID_COLUMN_GAP = 50;
  static readonly DEFAULT_APP_GRID_ROW_GAP = 24;
  static readonly DEFAULT_APP_ICON_SIZE_WIDTH = 70;
  static readonly DEFAULT_APP_NAME_SIZE= 12;
  static readonly DEFAULT_APP_NAME_HEIGHT = 25;
  static readonly DEFAULT_APP_ITEM_WIDTH = 72;
  static readonly DEFAULT_APP_ITEM_HEIGHT = 64;
  static readonly DEFAULT_APP_MARGIN = 10;
  static readonly DEFAULT_FOLDER_GRID_SIZE= 136;
  ...
  static readonly PERCENTAGE_80_number = 0.8;
  static readonly PERCENTAGE_75 = '75%';
  static readonly PERCENTAGE_70 = '70%';
  static readonly PERCENTAGE_15 = '15%';
  static readonly DEFAULT_APP_IMAGE = '/common/pics/img_app_default.png';
  static readonly DEFAULT_DELETE_IMAGE = '/common/pics/ic_public_delete.svg';
  static readonly DEFAULT_BACKGROUND_IMAGE_RECENT = '/common/pics/ic_wallpaper_recent.jpg';
  static readonly DEFAULT_RENAME_IMAGE = '/common/pics/ic_rename.svg';
  static readonly APP_IMAGE_WIDTH = 240;
  static readonly APP_IMAGE_HEIGHT = 430;
  static readonly DEFAULT_NUMBER = 20;
  static readonly DEFAULT_APP_LIST_ITEM_WIDTH = 90;
  static readonly DEFAULT_APP_LIST_ITEM_HEIGHT = 90;
  static readonly DEFAULT_ITEM_RADIUS = 8;
  static readonly DEFAULT_BUTTON_TEXT_SIZE= 23;
  static readonly PIXEL_50 = 50;
  static readonly PIXEL_200 = 200;
  ...
  static readonly DEFAULT_BROAD_COLOR = 'rgba(0,0,0,0.15)';
  static readonly DEFAULT_TRANSPARENT_COLOR = 'rgba(0,0,0,0)';
  static readonly CONTEXT_MENU_WIDTH = 243;
  static readonly DEFAULT_FORM_ITEM_WIDTH = 78;
  static readonly DEFAULT_FORM_ITEM_HEIGHT = 78;
  static readonly DEFAULT_FORM_FONT_TITLE_SIZE= 16;
  static readonly DEFAULT_FORM_FONT_CONTENT_SIZE= 20;
  static readonly DEFAULT_FORM_FONT_TITLE_WEIGHT= 500;
  static readonly DEFAULT_FORM_FONT_CONTENT_WEIGHT= 400;
  static readonly DEFAULT_FORM_REMOVE_DIALOG_WIDTH= 336;
