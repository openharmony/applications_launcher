...
export const EventConstants = {
  ...
  EVENT_OPEN_FOLDER_TO_CLOSE: 'launcher.event.EVENT_OPEN_FOLDER_TO_CLOSE',
  ...
  // form event
  EVENT_REQUEST_RECOMMEND_FORM_ADD: 'launcher.event.EVENT_REQUEST_RECOMMEND_FORM_ADD',
  EVENT_REQUEST_RECOMMEND_FORM_UPDATE: 'launcher.event.EVENT_REQUEST_RECOMMEND_FORM_UPDATE',
  EVENT_REQUEST_RECOMMEND_FORM_DELETE: 'launcher.event.EVENT_REQUEST_RECOMMEND_FORM_DELETE',
};