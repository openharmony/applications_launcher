...
export default class PhoneFolderLayoutConfig extends FolderLayoutConfig {
  ...
  static getInstance(): PhoneFolderLayoutConfig {
    if (globalThis.PhoneFolderLayoutConfig == undefined) {
      globalThis.PhoneFolderLayoutConfig = new PhoneFolderLayoutConfig();
      globalThis.PhoneFolderLayoutConfig.initConfig();
    }
    return globalThis.PhoneFolderLayoutConfig;
  }
